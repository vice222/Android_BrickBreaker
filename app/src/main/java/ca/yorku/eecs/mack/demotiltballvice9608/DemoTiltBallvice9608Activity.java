 ...
 *
 * Login ID - <vice9608>
 * Student ID - <214184253>
 * Last name - <Liu>
 * First name(s) - <Zian>
 */
public class DemoTiltBallvice9608Activity extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
      ...
      //  if (orderOfControl.equals("Velocity")) // velocity control
       ...
       // else
        ...
        rb.configure(pathType,orderOfControl);
    ...
    private class ScreenRefreshTimer extends CountDownTimer
    {
        ...
        public void onFinish()
        {
           ...
           if (pitch > 0 && roll > 0)
            ...
            if (orderOfControl.equals("Joy Stick"))
                rb.updateBallPosition(movement, roll, joyAng, flingVelocity);
            else if (orderOfControl.equals("Fling"))// will invalidate ball panel
                rb.updateBallPosition(movement, roll, flingAngle, flingVelocity);
    ...
    private OnGestureListener mOnGesture = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            double i = Math.atan2(velocityY, velocityX);
            float n  = (float)Math.toDegrees(i);
            if(n<=0&&n>(-90)) {
                flingAngle = n + 90;
                movement=true;
            }
